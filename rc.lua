...
redshift = require("awesome-redshift")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "space", function () awful.layout.inc(awful.layout.layouts, 1)  end, "Next Layout"),
    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(awful.layout.layouts, -1) end, "Previous Layout"),
